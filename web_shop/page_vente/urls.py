...
urlpatterns = [
    ...
    path(_('produits/'), views.tous_les_produits, name="produits"),
    ...
    path(_('paiement_reussi/'), views.success_view, name='payment_success'),
    path(_('paiement_annule/'), views.cancel_view, name='payment_cancel'),
]